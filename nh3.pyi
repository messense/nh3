...
class Cleaner:
    def __init__(
        ...
        add_tags: Optional[AbstractSet[str]] = None,
        rm_tags: Optional[AbstractSet[str]] = None,
        clean_content_tags: Optional[AbstractSet[str]] = None,
        add_clean_content_tags: Optional[AbstractSet[str]] = None,
        rm_clean_content_tags: Optional[AbstractSet[str]] = None,
        ...
        add_generic_attribute_prefixes: Optional[AbstractSet[str]] = None,
        rm_generic_attribute_prefixes: Optional[AbstractSet[str]] = None,
        ...
        add_url_schemes: Optional[AbstractSet[str]] = None,
        rm_url_schemes: Optional[AbstractSet[str]] = None,
